        ...
        <form class="form-horizontal" role="form" method="post" action="<?php echo $path; ?>order.php" accept-charset="UTF-8">
          <fieldset>
            ...
            <div class="form-group row">                
              ...
              <div class="col-sm-4">
                <input type="text" name="flightseat" placeholder="Seat Number" class="form-control" value="<?php if (isset($order)) {echo $order->get_flight_seat();}?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea id="requirements" name="requirements" class="form-control" placeholder="Other requirements, e.g. meal reservation, payment methods"><?php if (isset($order)) {echo $order->get_requirement();}?></textarea>
              </div>
            </div>
            <br>
            ...
            <div>
              <div class="col-xs-3 pull-right">
                <button type="submit" name="type" value="submit" class="btn btn-primary btn-block">
                  Submit
                </button>
              </div>
